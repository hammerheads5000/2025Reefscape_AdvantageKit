...
public class BoundaryProtections {
    ...
    public static final Translation2d adjustVelocity(Pose2d pose, Translation2d desiredVel) {
        ...
        Pose2d nearestPoint;
        if (nearestPerimeter.getTranslation().getDistance(pose.getTranslation())
                < nearestReef.getTranslation().getDistance(pose.getTranslation())) {
        ...
        if (nearestPoint.getTranslation().getDistance(pose.getTranslation())
