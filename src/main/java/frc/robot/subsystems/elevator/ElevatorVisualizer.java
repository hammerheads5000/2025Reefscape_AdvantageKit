...
public class ElevatorVisualizer {
    ...
    private final LoggedMechanism2d mechanism =
            new LoggedMechanism2d(Inches.of(28).in(Meters), Inches.of(72).in(Meters), new Color8Bit(Color.kAliceBlue));
    private final Translation2d rootPos = new Translation2d(0.6, 0.1);
    private final LoggedMechanismLigament2d ligament;

    public ElevatorVisualizer(String name, BooleanSupplier hasCoral, Supplier<Pose2d> poseSupplier) {
        this.name = name;
